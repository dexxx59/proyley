...
<div class="main main-raised">
    <div class="container">        
        ...
        <div class="section text-center">
            <h2 class="title">Imágenes del producto "{{ $product->nombre }}"</h2>
                   ...
                   <div class="col-md-4">
                        <div class="panel panel-default">
                          <div class="panel-body">
                           <img src="{{ $image->url }}" width="250" class="img-rounded img-responsive">
                           <form method="post" action="">
                               ...
                               {{ method_field('DELETE') }}
                                ...
                                @if($image->featured)
                                     <button type="button"  class="btn btn-info btn-fab btn-fab-mini btn-round" rel="tooltip" title="Imágen destacada actualmente">
