                        ...
                        @endif
                            ...
                            <div class="input-group">
                             ...
                             <div class="input-group">
                                ...
                                <input id="phone" type="phone" placeholder="Teléfono" class="form-control" name="telefono" value="{{ old('telefono') }}" required>
                            </div>                            
                            ...
                            <div class="input-group">
                                ...
                                <input id="address" type="text" placeholder="Dirección" class="form-control" name="direccion" value="{{ old('direccion') }}" required>
                            </div>  
